...
description: Run your own OpenRouter gateway.
---

This section is for teams who want to run the OpenRouter gateway on their own infrastructure. OpenRouter is designed to be lightweight, scalable, and easy to deploy using modern containerized or bare-metal setups.
